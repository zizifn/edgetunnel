...
// Only need to install package ws from npm
// To run, rename is file to "index.js" and place it in the same folder as "worker-vless.js",
// then create "package.json" as follows:
...
import {vlessOverWSHandler, setTCPConnectionHandler, getVLESSConfig} from './worker-vless.js';
